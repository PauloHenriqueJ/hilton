...
export default function Logo(){
    return(
      <div className="flex items-center">
        ...
        <span className=" bg-gradient-to-r from-blue-800 via-green-600 to-yellow-500 bg-clip-text text-transparent text-3xl lg:text-3xl text-grad
        font-bold shadow-sm">à HM pinturas</span>
        </div>
