...
export default function Menu(props: MenuProps) {
  return (
    <aside className={`boxed ${props.className ?? ''}`}>
      <nav className="fixed  top-0 left-0 w-full flex gap-5 sm:flex-row justify-start sm:justify-center items-start sm:items-center space-y-3 sm:space-y-0 sm:space-x-3 bg-white py-2 shadow-md">
